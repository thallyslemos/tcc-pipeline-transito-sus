...
def datasus_real_sia(tmp_path: Path):
    """Gera dados SIA no formato real DATASUS: todas as colunas VARCHAR."""
    records = [
        {"PA_CIDPRI": "V209", "PA_CODMUN": "2927408", "PA_DATREF": "202403",
         "PA_VALAPR": "1250.50", "PA_QTDAPR": "2", "PA_SEXO": "M",
         "PA_IDADE": "425", "UF": "BA"},
        {"PA_CIDPRI": "V499", "PA_CODMUN": "2927408", "PA_DATREF": "202406",
         "PA_VALAPR": "3500.00", "PA_QTDAPR": "1", "PA_SEXO": "F",
         "PA_IDADE": "445", "UF": "BA"},
        {"PA_CIDPRI": "V019", "PA_CODMUN": "2927408", "PA_DATREF": "202401",
         "PA_VALAPR": "800.25", "PA_QTDAPR": "3", "PA_SEXO": "M",
         "PA_IDADE": "308", "UF": "BA"},
        {"PA_CIDPRI": "X999", "PA_CODMUN": "2927408", "PA_DATREF": "202401",
...
def test_silver_sia_real_all_varchar(datasus_real_sia, tmp_path):
    """Silver SIA deve processar dados reais (todas colunas VARCHAR)."""
    import os
    os.environ["SILVER_DIR"] = str(tmp_path / "silver")
    from importlib import import_module, reload
    config_mod = import_module("data-pipeline.config")
